                                    ...
                                    <div class="border rounded">
                                        <div class="row bg-white">
                                            ...
                                            <div class="col-md-6">
												...
												<br>
                                                <h5 class="pt-2 " style="float:left;font-size:20px">prix/unité :<span class="text-success" style="font-size:20px"> <?=$row['buy_price']?>$</span></h5>
												<br>
												<br>
                                                <h5 class="pt-2" style="float:;font-size:20px" >Quantité: <span class="text-success" style="font-size:20px"><?=$cart['amount_product']?></span></h5>
